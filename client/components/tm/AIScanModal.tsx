...
import { InputWithVoice } from "@/components/ui/InputWithVoice"; // <-- Import the new component
...
export function AIScanModal({ open, onOpenChange, onFilled }: { open: boolean; onOpenChange: (v: boolean) => void; onFilled: (d: CustomerDetails) => void; }) {
  ...
  // This is the function connected to your Buildship workflow
  ...
  // A placeholder function for handling voice input for a specific field
  const handleVoiceInput = (fieldName: keyof CustomerDetails) => {
    toast.info(`Voice input for ${fieldName} is coming soon!`);
    // Here you would implement the Web Speech API to update the state:
    // For example: setDetails(prev => ({ ...prev, [fieldName]: "Voice result" }));
  };
          ...
          <div className="grid grid-cols-2 gap-3 pt-2">
            <div className="col-span-2">
              ...
              <InputWithVoice 
                ...
                onVoiceClick={() => handleVoiceInput('name')}
              />
            </div>
            <div>
              ...
              <InputWithVoice 
                ...
                onVoiceClick={() => handleVoiceInput('dob')}
              />
            </div>
            <div>
              ...
              <InputWithVoice 
                ...
                onVoiceClick={() => handleVoiceInput('idNumber')}
              />
            </div>
            <div className="col-span-2">
              ...
              <InputWithVoice 
                ...
                onVoiceClick={() => handleVoiceInput('address')}
              />
            </div>
          </div>
          <div className="pt-2">
